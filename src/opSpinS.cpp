...
namespace quantum_solver_ed{
  ...
  template class SpiSmj<double>;
  template class SpiSmj<cx_double>;
  template class SziSpj<double>;
  template class SziSpj<cx_double>;
  template class SziSmj<double>;
  template class SziSmj<cx_double>;
